/*
This package use French Governmental Address API which is like a database of address in France. Note that those address are not affilied to citizens and do not contain personal informations. This API returns addresses referenced in France. It's like Google API, but with more accurate informations of French addresses.
